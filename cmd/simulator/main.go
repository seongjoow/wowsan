...
func main() {
	...
	advLambda := float64(1) / 60 * 10 // 단위 시간당 평균 호출 횟수 λ (예: λ = 1/3 이면 3초에 한 번 호출)
	subLambda := float64(1) / 60 * 5
	pubLambda := float64(1) / 60 * 2
	...
	go simulator.RunPublisherSimulation(duration, advLambda, pubLambda, "localhost", "50001", "localhost", "60001", subjectList1)
	go simulator.RunPublisherSimulation(duration, advLambda, pubLambda, "localhost", "50002", "localhost", "60002", subjectList2)
	...
	go simulator.RunPublisherSimulation(duration, advLambda, pubLambda, "localhost", "50003", "localhost", "60003", subjectList3)
	...
	go simulator.RunPublisherSimulation(duration, advLambda, pubLambda, "localhost", "50004", "localhost", "60004", subjectList4)
	...
	go simulator.RunPublisherSimulation(duration, advLambda, pubLambda, "localhost", "50005", "localhost", "60005", subjectList5)
